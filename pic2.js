...
let url = "http://tw.shop.com/maso0310/search/htc"; // 目标网站

// 拿到网站内容转化成html字符串

html = requests('GET', {url , headers:{'uesr-agent':'node.js'}}).getBody().toString();
